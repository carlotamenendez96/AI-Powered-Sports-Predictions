...
| Edge check (is the model beating the price?) | `python3 scripts/run_edge_check.py [--since YYYY-MM-DD]` — also the **Edge Watch** pane's ▶ button on the landing page; writes `output/edge_checks/<ts>.{json,txt}` |
